...
vignette: >
  %\VignetteIndexEntry{CERMBhextools package examples}
...
The [CERMBhextools](https://github.com/mbedward/CERMBhextools) package provides functions to create hexagonal lattices, save these to file as vector layers (via the 'sf' package), and count points within hexagons.
